      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url(assets/img/slide/slide-1.jpg)">
          <div class="carousel-container">
            <div class="container">
              <h2 class="animate__animated animate__fadeInDown">Welcome to <span>SMK Negeri 15 Kota Bekasi</span></h2>
              <p class="animate__animated animate__fadeInUp">Sekolah Pusat Keunggulan.</p>
